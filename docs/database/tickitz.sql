...
ALTER TABLE cinemas ADD CONSTRAINT "fk_cinemas_movies" FOREIGN KEY ("movie_id") REFERENCES "public"."movies"("id") ON DELETE CASCADE ON UPDATE CASCADE;
ALTER TABLE order_history ADD CONSTRAINT "fk_movieid_movies" FOREIGN KEY ("movie_id") REFERENCES "public"."movies"("id") ON DELETE CASCADE ON UPDATE CASCADE;
ALTER TABLE order_history ADD CONSTRAINT "fk_cinemaid_cinemas" FOREIGN KEY ("cinema_id") REFERENCES "public"."cinemas"("id") ON DELETE CASCADE ON UPDATE CASCADE;
ALTER TABLE order_history ADD CONSTRAINT "fk_userid_users" FOREIGN KEY ("user_uid") REFERENCES "public"."users"("uid") ON DELETE CASCADE ON UPDATE CASCADE;


INSERT INTO "public"."movies" ("name", "release_date", "duration", "genres", "directed_by", "casts", "synopsis", "poster") VALUES
...
INSERT INTO "public"."cinemas" ("movie_id", "name", "city", "address", "show_times", "price", "logo") VALUES
...
INSERT INTO "public"."users" ("first_name", "last_name", "phone_number", "role", "email", "uid", "password", "photo_profile") VALUES
